...
export const collectionSchema = z.object({
  ...
  slug: z
    ...
    .refine((value) => slugPattern.test(value), {
      message: "Gunakan huruf kecil, angka, dan tanda hubung (contoh: koleksi-pertama).",
    }),
...
export const categorySchema = z.object({
  ...
  slug: z
    ...
    .toLowerCase()
    .refine((value) => slugPattern.test(value), {
      message: "Gunakan huruf kecil, angka, dan tanda hubung (contoh: eau-de-parfum).",
    }),
...
export const ingredientSchema = z.object({
  ...
  slug: z
    ...
    .toLowerCase()
    .refine((value) => slugPattern.test(value), {
      message: "Gunakan huruf kecil, angka, dan tanda hubung (contoh: kayu-cendana).",
    }),
