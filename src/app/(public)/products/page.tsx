...
function CategoryChip({
  ...
  return (
    <Link
      ...
      className={cn(
        "rounded-sm border border-border/60 px-4 py-2.5 text-body-sm text-muted-foreground transition-colors hover:border-terra-500/60 hover:text-terra-500 focus-visible:outline-none focus-visible:ring-3 focus-visible:ring-ring",
